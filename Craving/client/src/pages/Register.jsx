          ...
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            >
              ...
              <div className="mb-10">
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full h-fit px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none disabled:cursor-not-allowed focus:border-indigo-500 transition"
                  />
                  <input
                    type="tel"
                    name="mobileNumber"
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none disabled:cursor-not-allowed focus:border-indigo-500 transition"
                  />
                  <input
                    type="password"
              ...
              <div className="flex gap-4 pt-8 border-t-2 border-gray-200">
                ...
                <button
                  type="submit" className="flex-1 bg-linear-to-r from-indigo-600 to-indigo-700
